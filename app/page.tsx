...
export default function ComingSoonPage() {
  ...
  return (
    <div className="min-h-screen bg-[url('/bg-texture.png')] bg-cover bg-fixed bg-center bg-white flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto flex flex-col items-center">
        ...
        <div className="w-full max-w-5xl mx-auto text-center mb-10 sm:mb-12">
        ...
        <div className="w-full max-w-4xl relative px-4 sm:px-6 grid gap-8 sm:gap-10">
          {/* Main content card with premium styling */}
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl overflow-hidden border border-gray-100 transform transition-all duration-500 hover:shadow-2xl group">
            ...
            <div className="relative p-6 sm:p-10">
              <div className="text-center">
                ...
                <div className="mb-8 sm:mb-10 bg-gradient-to-r from-red-50 to-red-100 py-5 px-8 rounded-2xl inline-block shadow-sm border border-red-100">
                  ...
                  <p className="text-red-600 font-bold text-xl sm:text-2xl">{formattedOpeningDate}</p>
                </div>
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-lg overflow-hidden border border-gray-100 transform transition-all duration-500 hover:shadow-xl group">
